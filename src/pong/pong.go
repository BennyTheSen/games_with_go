...
func main() {
	...
	player1 := paddle{pos{50, 100}, 20, 130, color{0, 0, 255}}
	player2 := paddle{pos{float32(winWidth) - 50, 100}, 20, 130, color{0, 0, 255}}
	ball := ball{pos{300, 300}, 20, 3, 3, color{255, 0, 0}}
