...
func main() {
	...
	To the south a passage apperas to head upward. 
	...
	grue := storyNode{text: `While stumbling around in the darkness, you are
	eaten by the grue.`}
	trap := storyNode{text: `You head down the well traveled path when suddenly 
	a trap door opens and you fall into a pit`}
	treasure := storyNode{text: `You arrive at a small chamber, filled with 
	treasure!`}
